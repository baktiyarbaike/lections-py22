...
#        a. integer (int) -> Целое число (1, 2,4,5,6,..) 
...
# 5. sting (str) строка -> "Hello world" 
                        #  'Hello world'
# john = 'My name is John!'
# 6. set () - Множество
# 7. dict (Словари) -> содержит данные в виде ключа : -> {1: 'one',2: 'two'}
...
# Immutabul  (неизменяемые типы)

# 1. None
# 2. bool 
# 3. int (), float(), compilex()
# 4. str ()
# 5. range ()
# 6. tuple ()
